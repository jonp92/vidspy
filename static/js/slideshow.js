...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    videoStreamer.addEventListener("click", function(event) {
        ...
        overlayContext.fillRect(clickX, clickY, 20, 20); // Draw a small square at the click position
        overlayContext.strokeRect(clickX, clickY, 20, 20); // Draw a border around the square
        setTimeout(() => {
